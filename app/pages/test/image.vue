  ...
  <div class="space-y-8">
    ...
    <section class="grid gap-4 md:grid-cols-2">
      <article class="rounded-xl bg-white p-4 shadow-sm ring-1 ring-gray-100">
        ...
        <NuxtImg class="mt-3 h-56 w-full rounded-lg object-cover" src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1600&q=80" alt="Mountain sunset" sizes="sm:100vw md:640px" width="640" height="360" format="webp" placeholder="/images/placeholder.png" loading="lazy" />
        <p class="mt-3 text-sm text-gray-600">Ảnh internet được render qua IPX, tự co giãn theo viewport (full width trên mobile, 640px trên desktop) và dùng placeholder local.</p>
      </article>
      ...
      <article class="rounded-xl bg-white p-4 shadow-sm ring-1 ring-gray-100">
        ...
        <div class="relative mt-3 overflow-hidden rounded-lg bg-slate-50">
          <NuxtImg class="h-56 w-full object-cover" src="https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=1200&q=80" alt="Forest river" placeholder="/images/placeholder.png" width="640" height="360" quality="80" />
        </div>
    ...
    <section class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-gray-100">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-sm text-gray-600">Copy snippet để nhúng ảnh remote với placeholder và sizes responsive qua Nuxt Image.</p>
        </div>
