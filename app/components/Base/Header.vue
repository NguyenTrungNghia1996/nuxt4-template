<template>
  <div
    class="flex h-full w-full items-center justify-between border-b border-gray-700 bg-gray-900 px-6">
    <!-- Logo with modern glow effect -->
    <div class="flex items-center">
      <img
        :src="unitStore.logo"
        alt="Logo"
        class="h-16 cursor-pointer rounded-xl p-2 transition-all duration-300 ease-out hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 active:scale-95 active:shadow-none"
    ...
    <div class="flex items-center">
      <a-dropdown>
        <div
          class="group flex cursor-pointer items-center rounded-lg p-1.5 transition-all duration-200 ease-out hover:bg-gray-700/50"
          @click.prevent>
          <div class="flex items-center gap-3">
            ...
            <div class="relative">
              <a-avatar
                ...
                class="h-9 w-9 transition-all duration-300 ease-out group-hover:scale-110 group-hover:ring-2 group-hover:ring-blue-400" />
              <a-avatar
                v-else
                class="h-9 w-9 bg-gray-600 transition-all duration-300 ease-out group-hover:scale-110 group-hover:ring-2 group-hover:ring-blue-400"
        ...
        <template #overlay>
          <a-menu
            class="min-w-[180px] rounded-lg border border-gray-700 bg-gray-800 py-1 shadow-xl">
            ...
            <a-menu-item
              key="change_password"
              class="!mx-0 !px-4 !py-2.5 text-gray-200 hover:bg-gray-700/50 hover:text-white"
    ...
    <a-modal
      ...
      class="[&_.ant-modal-content]:bg-gray-800 [&_.ant-modal-header]:bg-gray-800 [&_.ant-modal-title]:text-white"
      :footer="null">
      <a-form
        layout="vertical"
        :model="passwordForm"
        ...
        ref="passwordFormRef"
        autocomplete="off"
        class="[&_.ant-form-item-label]:font-medium [&_.ant-form-item-label]:text-gray-300 [&_input]:border-gray-600 [&_input]:bg-gray-700 [&_input]:text-white">
        ...
        <div class="flex justify-end gap-3 pt-2">
          <a-button
            @click="handleCancel"
            class="border-gray-600 text-gray-300 hover:border-blue-400 hover:bg-gray-700/50 hover:text-white">
            Hủy bỏ
          </a-button>
          <a-button
            type="primary"
            ...
            class="border-blue-600 bg-blue-600 hover:bg-blue-500">
            Xác nhận
          </a-button>
        </div>
      </a-form>
